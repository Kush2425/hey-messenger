...
function Login(_a) {
    ...
    return (react_1["default"].createElement(theme_1.Box, { flex: 1, backgroundColor: "primary", padding: "xl", justifyContent: "center", alignItems: "center" },
        react_1["default"].createElement(theme_1.Box, { width: width * 0.9, borderRadius: "l", backgroundColor: "white", padding: "l", alignItems: "center" },
            ...
            react_1["default"].createElement(theme_1.Box, { style: { width: width * 0.7 }, marginBottom: "m" },
            ...
            react_1["default"].createElement(theme_1.Box, { style: { width: width * 0.7 }, marginBottom: "m" },
                react_1["default"].createElement(FormTextInput_1["default"], { placeholder: "Password", onChangeText: function (password) { return setPassword(password); }, secureTextEntry: true, style: {
                        marginBottom: 30
                    } })),
